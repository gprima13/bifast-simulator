...
/**
 * REST controller for managing {@link com.alto.id.bifast.simulator.domain.TestCase}.
 */
@RestController
...
public class TestCaseResource {
    ...
    private static final String ENTITY_NAME = "bifastsimulatorTestCase";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<TestCaseDTO>> getAllTestCases(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
