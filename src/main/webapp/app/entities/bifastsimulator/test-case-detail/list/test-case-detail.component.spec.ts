...
import { sampleWithRequiredData } from '../test-case-detail.test-samples';
...
describe('TestCaseDetail Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.testCaseDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to testCaseDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTestCaseDetailIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTestCaseDetailIdentifier).toHaveBeenCalledWith(entity);
