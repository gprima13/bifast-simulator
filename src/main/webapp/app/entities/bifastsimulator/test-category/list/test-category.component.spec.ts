...
import { sampleWithRequiredData } from '../test-category.test-samples';
...
describe('TestCategory Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.testCategories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to testCategoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTestCategoryIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTestCategoryIdentifier).toHaveBeenCalledWith(entity);
